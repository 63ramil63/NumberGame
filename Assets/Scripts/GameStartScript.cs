...
public class GameStartScript : MonoBehaviour
{
    ...
    [Header("Текстуры для заднего плана")]
    ...
    void Start()
    {
        ...
        {
            backGround.GetComponent<SpriteRenderer>().sprite = sprites[Random.Range(0, sprites.Length - 1)];
        }

        ScaleToFillCamera(backGround, Camera.main, false);
